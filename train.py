...
if __name__ == '__main__':
    ...
    if data_set=="gaze360":
        ...
        load_filtered_state_dict(model, pre_url)
        ...
        val_dataset=datasets.Gaze360(val_path,args.gaze360image_dir, transformations, 180, 4, train=False)
        ...
        for epoch in range(num_epochs):
            ...
            with torch.no_grad():
                for j, (images, labels, cont_labels, name) in enumerate(val_loader):
                    ...
                    pitch_predicted = \
                        torch.sum(pitch_predicted * idx_tensor, 1).cpu() * 4 - 180
                    yaw_predicted = \
                        torch.sum(yaw_predicted * idx_tensor, 1).cpu() * 4 - 180
